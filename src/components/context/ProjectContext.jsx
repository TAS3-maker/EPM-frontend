...
export const ProjectProvider = ({ children }) => {
 ...
 const fetchProjects = async () => {
  ...
  try {
    ...
    if (response.ok) {
      // console.log("Fetched projects:", data.data); // <--- log here to check
  ...
  setMessage("");
  try {
    console.log("Sending update for:", id, updatedData); // 👈 Add this
    ...
    console.log("Update response data:", data); // 👈 Add this
    ...
    if (response.ok) {
      ...
      await fetchProjects(); // Make sure this is awaited 👈
    } else {
      showAlert({
        variant: "error",
        title: "Error",
