...
const addTeam = async (teamData) => {
  // teamData = { name: "test", department_id: "2" }
  setIsLoading(true);
  setMessage(null);
  ...
  try {
    const response = await fetch(`${API_URL}/api/teams`, {
      ...
      body: JSON.stringify(teamData), // ✅ send directly, not wrapped
    });
    ...
    const fallbackMessage = "Something went wrong while adding the team!";
