...
export const PMunassigned = () => {
  ...
  const [selectedClientType, setSelectedClientType] = useState("Not Assigned");
...
const filteredTableProjects = useMemo(() => {
  ...
  return employeeProjects.data.projects.filter((project) => {
    ...
    // Apply search filter on project_name, client_name, or team_leads name
    ...
    if (filterBy === "team_leads") {
      // This is to handle edge case when searching by team_leads,
      // for unassigned projects, this will generally be false since team_leads is empty,
      // but allows filtering if there's no team leads and empty query
      return query === "";
    }
                    ...
                    {loading ? (
                        ...
                        <div className="flex items-center justify-center min-h-[400px]">
                            <div className="text-center bg-white p-8 rounded-xl shadow-lg">
                                <p className="text-xl font-semibold text-gray-700 mb-2">No Unassigned projects found</p>
                                {searchQuery && (
