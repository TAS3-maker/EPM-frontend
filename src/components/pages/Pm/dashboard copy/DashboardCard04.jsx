...
function DashboardCard04() {
  ...
  return (
    <div className="flex rounded-lg shadow-lg flex-col col-span-full sm:col-span-12 xl:col-span-12 bg-white shadow-xs rounded-xl">
      <StatCardHeader icon={UserPlus} title="Billable / In-house / No-work"  />
