...
<div className="relative">
  ...
  >
    <Calendar className="h-5 w-5 text-gray-400 mr-2 transform scale-150" />
  </div>

  {isCustomMode && (
    <div className="absolute top-full left-0 mt-4 z-50 bg-white p-3 rounded shadow-lg flex gap-2">
      <input
        type="date"
      ...
      <CancelButton className="cancel-btn" onClick={clearFilter2} />
    </div>
  )}
</div>
