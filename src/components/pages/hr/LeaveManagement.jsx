  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-lg font-bold mb-4 text-gray-800 border-b pb-2">Leave Details</h2>
        <div className="space-y-3 text-gray-700">
          ...
          <p className="text-[12px]">
            <span className="font-semibold text-[12px]">Leave Type:</span> {leaveDetails.leave_type || "N/A"}
          </p>
    ...
    <div className="rounded-2xl border border-gray-200 bg-white shadow-lg max-h-screen overflow-y-auto">
      ...
      {isModalOpen1 && (
        ...
        >
          {/* Overlay */}
          <div
            className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-md animate-fadeIn"
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col items-start sm:items-center justify-between gap-4">
                  ...
                  <div className="w-full">
                    <label className="block text-[12px] font-medium text-gray-700 mb-2 flex items-center">
                    ...
                    <select
                      ...
                      className="block w-full px-4 py-2 border-2 border-gray-200 rounded-lg shadow-sm
               focus:ring-2 focus:ring-blue-500 focus:border-transparent text-[12px]"
                      required
                    >
                  ...
                  <div className={`relative ${showHours ? 'sm:w-12/12' : 'sm:w-full'} w-full`}>
                    <label htmlFor="leave-type" className="block text-[12px] font-medium text-gray-700 mb-2 flex items-center">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="block  w-full px-4 py-2 text-[12px] border-2 border-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 ease-in-out appearance-none bg-white"
                      >
                  ...
                  {showHours && (
                    <div className="w-full sm:w-12/12 space-y-3">
                      <label className="block text-[12px] font-medium text-gray-700 flex items-center">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex gap-2 items-center">
                          <select
                            ...
                            className="flex-1 px-4 py-2 border border-gray-300 rounded-lg text-[12px] font-mono tracking-wider w-full max-w-[50%] h-11"
                          >
                          ...
                          <select
                            ...
                            onChange={handleChange}
                            className="w-full max-w-[50%] px-3 py-2 border border-gray-300 rounded-lg text-[12px] h-11"
                          >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div className={`relative ${showEndDate ? 'sm:w-6/12' : 'sm:w-full'} w-full`}>
                    <label htmlFor="start-date" className="block text-[12px] font-medium text-gray-700 mb-2 flex items-center">
                  ...
                  {showEndDate && (
                    <div className="relative w-full sm:w-6/12">
                      <label htmlFor="end-date" className="block text-[12px] font-medium text-gray-700 mb-2 flex items-center">
                        <Calendar className="w-4 h-4 mr-2 text-gray-400" />
                        End Date
                      </label>
                      <input
                ...
                <div className="relative group">
                  <label htmlFor="leave-reason" className="block text-[12px] font-medium text-gray-700 mb-2 flex items-center">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="block w-full px-4 py-2 text[12px] border-2 border-gray-200 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-none min-h-[100px] max-h-[400px] hover:shadow-md group-hover:shadow-lg"
                ...
                <div className='relative'>
                  <label htmlFor="leave-documents" className="block text-[12px] font-medium text-gray-700 mb-2 flex items-center">
                    <FileText className="w-4 h-4 mr-2 text-gray-400" />
                    ...
                    {documentURL && (
                      <div className="mt-3 flex items-center gap-4">
                        ...
                        <a
                          ...
                          className="text-blue-600 hover:text-blue-800 underline text-[12px]"
                          target="_blank"
                        ...
                        {leave.documents.toLowerCase() && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-green-600 hover:text-green-800 underline text-[12px]"
                          >
                            Preview
                          </a>
                        )}
                    ...
                    <div className="mt-auto pt-3 border-t border-gray-100 flex items-center justify-between w-full">
                      {editMode[leave.id] ? (
                        <div className="flex items-center gap-4">
                          <div className="relative group">
                            ...
                            <span className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2
                                                        whitespace-nowrap bg-white text-black text-[12px] px-2 py-1 rounded
                        ...
                        <>
                          ...
                          <span className={`px-3 py-1 rounded-full text-[12px] font-medium ${(leave.status || '').toLowerCase() === "approved" ? "bg-green-100 text-green-700" :
