...
import { CheckCircle, XCircle, Pencil, Ban, Save, Edit, CalendarDays, Trash2, Eye, UserPlus, FolderSync, Briefcase, Loader2, UserRound, Tag, Clock } from "lucide-react"; // Added Loader2, UserRound, Tag, Clock icons
...
const DashboardCard02 = () => {
  ...
  return (
    <div className="md:col-span-12 xl:col-span-5 bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden transform transition-all duration-300 ease-in-out hover:shadow-2xl hover:border-blue-200">
              ...
              {loading ? (
                ...
                leaves.map((leave, index) => (
                  <tr key={leave.id} className={`group ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-gray-100 transition duration-200 ease-in-out cursor-pointer`}>
                    ...
                    <td className="py-4 px-2 sm:px-3 text-center text-gray-700 font-mono text-xs">
