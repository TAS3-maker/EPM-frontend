...
const DashboardCard06 = () => {
  ...
  return (
    <div className="col-span-full xl:col-span-5 bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden transform transition-shadow duration-300 ease-in-out hover:shadow-2xl hover:border-blue-200">
      <StatCardHeader icon={Briefcase} title="Total Projects in Department" tooltipPosition="bottom" />
      
      <div className="flex items-center justify-center p-4 h-[260px]">
        {loading ? (
