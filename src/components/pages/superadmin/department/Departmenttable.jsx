...
export const Departmenttable = () => {
  ...
  const pagedepartment = filteredDepartment.slice(
  ...
  const handleSaveClick = async () => {
    ...
    setIsUpdating(true);
    const result = await updateDepartment(editRoleId, editRoleName);
    setIsUpdating(false);
    ...
    <div className="rounded-2xl border border-gray-200 bg-white shadow-lg max-h-screen overflow-y-auto ">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-2 sm:sticky top-0 bg-white z-10 shadow-md">
        ...
        <div className="flex flex-wrap md:flex-nowrap items-center gap-3 border p-2 rounded-lg shadow-md bg-white">
          ...
          <ExportButton onClick={() => { exportToExcel(filteredDepartment, "Department.xlsx"); }}
          />
        </div>
      </div>
                ...
                <tr>
                  <td colSpan="4" className="px-6 py-8 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="mt-1 text-sm text-gray-500">No Department have been created yet.</p>
                    </div>
                  </td>
                </tr>
              )}
        ...
        <div className="fixed inset-0 bg-gray-800 bg-opacity-70 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded shadow-lg max-w-sm w-full m-2">
            ...
            <div className="flex justify-end gap-2 my-2">
              ...
              <YesButton onClick={() => {
                deleteDepartment(editid); // Use editid which stores the ID of the role to be deleted
